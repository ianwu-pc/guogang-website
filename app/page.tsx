      ...
      <section className="home-guides" id="home-guides" aria-label="認識過港的地方、好味與人物">
        <article className="home-guide home-guide-place">
          ...
          <div className="home-guide-copy">
            ...
            <h2><span className="heading-line">一個名字，</span><span className="heading-line">從河的另一岸</span><span className="heading-line">開始。</span></h2>
        ...
        <article className="home-guide home-guide-goods">
          ...
          <div className="home-guide-copy">
            ...
            <h2><span className="heading-line">把熟悉的日常，</span><span className="heading-line">做成可以分享的</span><span className="heading-line">味道。</span></h2>
        ...
        <article className="home-guide home-guide-people">
          ...
          <div className="home-guide-copy">
            ...
            <h2><span className="heading-line">過港的樣子，</span><span className="heading-line">藏在生活於這裡</span><span className="heading-line">的人身上。</span></h2>
        ...
        <article className="home-guide home-guide-about">
          ...
          <div className="home-guide-copy">
            ...
            <h2><span className="heading-line">一群人一起做的</span><span className="heading-line">事，</span><span className="heading-line">慢慢成了社區的</span><span className="heading-line">力量。</span></h2>
        ...
        <section className="home-more" aria-labelledby="home-more-title">
          <div className="home-more-copy">
            ...
            <h2 id="home-more-title"><span className="heading-line">如果喜歡過港，</span><span className="heading-line">也歡迎把這份味道</span><span className="heading-line">帶回家。</span></h2>
