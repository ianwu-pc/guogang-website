        ...
        {activeLocation && details && placeCopy && <div className="guogang-map-place">
          ...
          <div className="guogang-map-google">
            ...
            {photo && <figure className="guogang-map-place-photo" key={photo.src}>
              <img src={sitePath(photo.src)} alt={`${activeLocation.name}實景照片`} width={photo.width} height={photo.height} style={photo.width < photo.height ? { aspectRatio: "3 / 2", objectFit: "cover" } : undefined} decoding="async" />
